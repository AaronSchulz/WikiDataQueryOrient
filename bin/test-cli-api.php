...
$queries[] = 'SELECT (id) FROM {HPwNoV[1,2,3]}';
$queries[] = 'SELECT (id) FROM {HPwIV[31:1,2,3]}';
$queries[] = 'SELECT (id) FROM {HPwSV[311:"cat","says","meow"]}';
$queries[] = 'SELECT (id) FROM {HPwQV[31:1.0,2,33 TO 63]}';
$queries[] = 'SELECT (id) FROM {HPwTV[131:1.0,2,-1111133 TO 1111163]}';
$queries[] = 'SELECT (id) FROM {HPwCV[131:AROUND 1.1 -2.2 3.3,AROUND -1.1 -2.2 3.3]}';
$queries[] = 'SELECT (id) FROM {HPwIV[31:1,2,3] WHERE(HPwQV[1:3.141596] OR HPwQV[353:2525])}';
$queries[] = 'SELECT (id) FROM {HPwIV[31:1,2,3] QUALIFY(HPwIV[15141:222,252,353])}';
