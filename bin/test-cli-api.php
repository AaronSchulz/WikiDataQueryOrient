...
$queries[] = 'SELECT (id,labels["en"] AS label) FROM {HIaPV[31:1,2,3] WHERE(HIaPV[41:14] OR NOT (HIaPV[321:1]))}';
...
$queries[] = 'SELECT (id,labels["en"] AS label) FROM {HPwSV[311:"O\'reilly Pub\""] WHERE(NOT (HIaPV[31:1,2,3]))}';
