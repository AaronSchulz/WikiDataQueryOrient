...
$queries[] = '(id,labels["en"] AS label,sitelinks["enwiki"] AS link,claims["P279"][sid] AS claims) FROM {HP[31,279] LIMIT(5)}';
...
$queries[] = '(id,labels["en"] AS label,sitelinks["enwiki"] AS link) FROM {HPwCV[625:AROUND 38.897669444444 -77.03655 2,AROUND -1.1 -2.2 3.3] LIMIT(5)}';
